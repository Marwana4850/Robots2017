...
public class ChangeSquare extends DifferentialPilot {
	...
	public void recalage() {
		// cette fonction doit être appelée quand la case où on veut aller est
		...
		// Button.waitForAnyPress();
		LCD.clear();
		// après cette fonction de recalage, on arrive un peu avant ligne
		// blanche,
		// il faut alors se remettre droit grâce à celle-ci
		// -> en fait il suffit d'appeler la fonction avanceUneCase()

		/*
		 * Fonction : tourner la tête à gauche (tete.rotateTo(-180)), si
		 * dist>... tourner la tête à droite (tete.rotateTo(180) si dist>... ne
		 * rien faire
		 * 
